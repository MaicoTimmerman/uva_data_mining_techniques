...
training_data = pd.read_csv("../data/tenth_train.csv")
validation_data = pd.read_csv("../data/tenth_valid.csv")
test_data = pd.read_csv("../data/tenth_test.csv")
...
if not os.path.exists("../data/train_bin"):
    # Fist step of data preprocessing
    preprocessing_3(training_data, type=1)
    preprocessing_3(validation_data, type=0)
...
model = LambdaMART(
    metric='NDCG@38', max_leaf_nodes=7, shrinkage=0.07,
    estopping=100,
    n_jobs=-1,
    random_state=42,
    use_pines=True,
